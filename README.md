...
- [New Unit-Lindley Mixed Model for Bounded Responses](link_to_publication)  
- [Carbon Emissions in South Asia: Long-run Evidence](link_to_publication)  
- Add other publications or research projects here
